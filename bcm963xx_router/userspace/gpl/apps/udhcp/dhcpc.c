 ...
 * so function renew_requested() will be called. If state is BOND, serveraddr will get 0, and state set to RENEW_REQUESTED.
 * However, serveraddr can only be update when state is INIT_SELECTING.
 * Finally, serveraddr is always 0, and dhcpc will send broadcast again and again.
 */
...
/*
    ...
    #if defined(SUPPORT_GPL) //add william 2012-3-15
