...
/*****************************************************************************/
void dns_list_unarm_all_requests(int query_type)
{
   ...
   if(tmp->message.question[0].type == query_type)
   {
      tmp->switch_on_timeout = 0;
   }

   dns_list_unarm_requests_after_this(tmp,query_type);
...
/*****************************************************************************/
void dns_list_unarm_requests_after_this(const dns_request_t *r, int query_type)
{
   dns_request_t *tmp;
